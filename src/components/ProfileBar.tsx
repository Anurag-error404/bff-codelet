    ...
    <div className="sidebarp">
      ...
      <div className="social-media-div">
        ...
        <div className="social-media">
          ...
          >
            your-linkedin-username{linkedinUsername}
          </p>
        </div>
      </div>
      ...
      <div className="skills-div">
        ...
        <div className="skills">
          <i
            ...
            style={{ fontSize: "8px", color: "red", marginRight: "10px" }}
          ></i>
          <p
            style={{
              color: "white",
        ...
        <div className="skills">
          <i
            className="fa fa-circle"
            style={{ fontSize: "8px", color: "yellow", marginRight: "10px" }}
          ></i>
          <p
            style={{
              color: "white",
        ...
        <div className="skills">
          <i
            className="fa fa-circle"
            style={{ fontSize: "8px", color: "green", marginRight: "10px" }}
          ></i>
          <p
            style={{
              color: "white",
